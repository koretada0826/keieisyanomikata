...
const ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "人を雇う場合、給与だけでなく社会保険（約15%）・交通費（約1万円/月）・残業/有給コスト（約10%増）・教育コスト・管理コストがかかります。さらに最大のリスクは離職です。経営者のミカタなら離職なし・教育不要・パフォーマンス一定で、営業3人分の稼働を実現します。具体的な月額はお問い合わせ時にご案内いたします。",
  },
  {
    q: "どのくらいで成果が出ますか？",
